...
LANGUAGES = [
    ...
    "Gujarati", "Odia", "Punjabi", "Assamese", "Maithili", "Santali", "Konkani", "Manipuri",
    "Urdu", "Dogri"
]
...
with st.sidebar:
    ...
    # Response Length
    length = st.selectbox("Response Length", LENGTH_OPTIONS, index=1)
...
with tabs[0]:
    ...
    2. Choose your **Level**, **Language**, and **Response Length**.  
        ...
        with st.spinner("Generating chapter summary..."):
            try:
                payload = {
                    "subject": subject,
                    "level": level,
                    "question": f"Explain the chapter {chapter}",
